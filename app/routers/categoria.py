...
from app.crud.categoria import registrar_categoria as registrar_categoria_db, obtener_categoria as obtener_categoria_db, actualizar_categoria as actualizar_categoria_db
...
@router.get("/{id_Categoria}", response_model=CategoriaConsulta)
