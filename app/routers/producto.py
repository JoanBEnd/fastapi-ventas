...
from app.crud.producto import registrar_producto as registrar_producto_db, obtener_producto as obtener_producto_db, actualizar_producto as actualizar_producto_db
...
@router.get("/{Id_Producto}", response_model=ProductoConsulta)
