...
from app.crud.empleado import registrar_empleado as registrar_empleado_db, obtener_empleado as obtener_empleados_db, actualizar_empleado as actualizar_empleado_db
...
@router.get("/{Id_Empleado}", response_model=EmpleadoConsulta)
